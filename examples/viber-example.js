...
const Botanalytics = require('botanalytics').Viber(process.env.BOTANALYTICS_TOKEN, {
    debug: true
});
...
http.createServer(bot.middleware()).listen(port, () => bot.setWebhook('https://yourwebhookurl.com'));
